...
/**
 * Exception for errors occurred during the training of a ML Model.
 *
...
public class ModelTrainingException extends Exception {
     ...
     */
    public ModelTrainingException(final String message) {
        super(message);
    }
     ...
     *                unknown.)
     */
    public ModelTrainingException(final String message, final Throwable cause) {
        super(message, cause);
    }
