...
/**
 * Tests the {@link AbstractValueSchema} validation behaviour.
 *
...
public class AbstractValueSchemaTest {
    ...
    public void testValidateAllowMissing() {
        final AbstractValueSchema valueSchema = new AbstractValueSchema(true) { };
    ...
    public void testValidateNotAllowMissing() {
        final AbstractValueSchema valueSchema = new AbstractValueSchema(false) { };
        assertTrue("Non missing value should always be valid", valueSchema.validate(VALID_VALUE));
